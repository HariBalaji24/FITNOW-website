...
const Home = () => {
  ...
  return (
    <motion.div
      initial={{ opacity: 0, y: -40 }}   // 👈 appears from top
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 max-w-6xl">
        ...
        >
          ...
          >
            ...
            <Link to={"/workout"}><button className="px-6 py-3 border border-purple-500 text-purple-300 rounded-full font-semibold hover:bg-purple-500 hover:text-white transition">
              View Workouts
            </button></Link>  
          </motion.div>
        </motion.div>
        ...
        >
          <img
            src="https://e7.pngegg.com/pngimages/95/773/png-clipart-weight-training-muscle-bodybuilding-barbell-lean-body-mass-chest-muscle-physical-fitness-arm-thumbnail.png"
            alt="Fitness model"
